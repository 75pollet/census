defmodule CensusWeb.CitizenLiveTest do
  ...
  @create_attrs %{dob: %{day: 21, hour: 10, minute: 25, month: 8, year: 2022}, city: "some city", county: "some county", email_address: "some email_address", first_name: "some first_name", last_name: "some last_name", national_id: "some national_id", occupation: "some occupation"}
  @update_attrs %{dob: %{day: 22, hour: 10, minute: 25, month: 8, year: 2022}, city: "some updated city", county: "some updated county", email_address: "some updated email_address", first_name: "some updated first_name", last_name: "some updated last_name", national_id: "some updated national_id", occupation: "some updated occupation"}
  @invalid_attrs %{dob: %{day: 30, hour: 10, minute: 25, month: 2, year: 2022}, city: nil, county: nil, email_address: nil, first_name: nil, last_name: nil, national_id: nil, occupation: nil}
